...
And a discrete-time Kalman filter can then be constructed from $\{\mathcal{A}_\delta,C_\delta\}$ and appropriate noise models. \Cref{eq:TheisticDisturbanceEstimator} can be extended to the vector case by block-diagonal concatenation of several signal models, i.e. in the 2-dimensional case:
