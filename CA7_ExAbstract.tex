...
% as the top. (e.g., "\begin{figure*}[!b]" is not normally possible in
	...
	\begin{document}
		...
		The proposed control structure achieves offset-free EWR level regulation, as seen on \cref{fig:OuterLoop}, once the supporting KF has converged to the actual consumer disturbances. After packet loss is introduced, the behaviour of the system becomes oscillatory, but remains stable in the averaged sense, agreeing with \cite{Hu2007}.
