...
% as the top. (e.g., "\begin{figure*}[!b]" is not normally possible in
	...
	\begin{document}
		...
		\author{\IEEEauthorblockN{
				...
				Mathias Clement Frederiksen\IEEEauthorrefmark{0},
				...
				Kasper Laustsen\IEEEauthorrefmark{0}, and 
		...
		\begin{abstract}\label{sec:Abstract}
			High quality control of Water Distribution Networks (WDN) is critical to reliable supply of drinking water to consumers, but is subject to complex nonlinear dynamics and losses induced by actuator characteristics, unmeasured disturbances, and long-distance wireless communication. We achieve constant elevated water reservoir (EWR) level via an outer velocity-form Linear Quadratic Regulator (VF-LQR) and an inner PID pump control loop. Disturbance rejection in the outer loop and leakage detection are facilitated by a Kalman filter (KF) based on a harmonic disturbance model. Comprehensive experimental validation of the proposed control paradigm is presented, and an analytical proof of marginal stabilisability for arbitrarily large packet loss under the assumption of a Try-Once-and-Discard (TOD) protocol is given. 
			\\
			Keywords: Water Distribution, LQR, Networked Control
		\end{abstract}
